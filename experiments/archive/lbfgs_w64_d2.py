"""L-BFGS optimizer, w64, d2.

Stochastic L-BFGS with large batches and fewer epochs. The zoom linesearch
controls the step size, so there is no learning rate to tune. Each "epoch"
may involve multiple function evaluations internally (linesearch).
"""
