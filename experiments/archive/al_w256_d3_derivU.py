"""Derivative loss (uRL only): Adam (10k) -> L-BFGS (1k), w256 d3.

deriv_uRL_weight is set after hyperparameter sweep.
"""
...
DERIV_URL_WEIGHT = 0.1  # tuned by sweep: best med_fstar among [0.001, 0.01, 0.1, 1.0]

exp = Experiment(
    name="al_w256_d3_derivU",
    ...
    loss_kwargs={"deriv_uRL_weight": DERIV_URL_WEIGHT},
