"""Derivative loss (rho only): Adam (10k) -> L-BFGS (1k), w256 d3.

deriv_rho_weight is set after hyperparameter sweep.
"""
...
DERIV_RHO_WEIGHT = 0.01  # tuned by sweep: best med_rel_err among [0.001, 0.01, 0.1, 1.0]

exp = Experiment(
    name="al_w256_d3_derivRho",
    ...
    loss_kwargs={"deriv_rho_weight": DERIV_RHO_WEIGHT},
